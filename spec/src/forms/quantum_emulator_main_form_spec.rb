...
describe QuantumEmulatorMainForm do
  ...
  context 'the spinner area' do
    ...
    specify { expect(@spinpanel.components[1].model.maximum).to eq(100_000) }
    specify { expect(@spinpanel.components[3].model.maximum).to eq(100_000) }
    specify { expect(@spinpanel.components[5].model.maximum).to eq(100) }
    specify { expect(@spinpanel.components[7].model.maximum).to eq(100_000) }
